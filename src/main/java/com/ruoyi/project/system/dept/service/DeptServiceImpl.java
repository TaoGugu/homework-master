...
public class DeptServiceImpl extends ServiceImpl<DeptMapper,Dept> implements IDeptService
{
    ...
    {
        List<Dept> deptList = this.baseMapper.selectDeptList(dept);
    ...
    public int selectDeptCount(Long parentId)
    {
        ...
        return this.baseMapper.selectDeptCount(dept);
    }
    ...
    {
        Dept info = this.baseMapper.selectDeptById(dept.getParentId());
        ...
        return this.baseMapper.insertDept(dept);
    }
    ...
    {
        Dept newParentDept = this.baseMapper.selectDeptById(dept.getParentId());
        ...
        int result = this.baseMapper.updateDept(dept);
    ...
    private void updateParentDeptStatusNormal(Dept dept)
    {
        ...
        this.baseMapper.updateDeptStatusNormal(deptIds);
    }
    ...
    {
        List<Dept> children = this.baseMapper.selectChildrenDeptById(deptId);
    ...
    public void updateDeptChildren(Long deptId, String ancestors)
    {
        ...
        List<Dept> childrens = this.baseMapper.selectDeptList(dept);
        ...
        if (childrens.size() > 0)
        {
            this.baseMapper.updateDeptChildren(childrens);
        }
    }
    ...
    public String checkDeptNameUnique(Dept dept)
    {
        ...
        Dept info = this.baseMapper.checkDeptNameUnique(dept.getDeptName(), dept.getParentId());
